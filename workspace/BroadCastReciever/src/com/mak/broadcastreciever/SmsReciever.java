package com.mak.broadcastreciever;
...
public class SmsReciever extends BroadcastReceiver{
	...
	public void onReceive(Context context, Intent intent) {
		...
		if(intent.getAction().equals("android.provider.Telephony.SMS_CB_RECEIVED"))
		{
			...
			String number=null;
			String message=""; //pdus mane "protocol data unit"; msg ar datatype janina bole object cls thke nicchi karon sob data type akhane thake
